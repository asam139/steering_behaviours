        ...
        if (e.type == SDL_KEYDOWN) {
            switch (e.key.keysym.sym) {
                ...
                case SDLK_F5:
                    ...
                    break;
                case SDLK_UP: {
                    float newSpeed = world_.target()->getKinematic()->speed + 1;
                    if (newSpeed > 10.0f) {
                        newSpeed = 10.0f;
                    }
                    world_.target()->getKinematic()->speed = newSpeed;
                    break; }
                case SDLK_DOWN: {
                    float newSpeed = world_.target()->getKinematic()->speed - 1;
                    if (newSpeed <= 0.0f) {
                ...
                case SDLK_1:
                    world_.setAISteering(Body::SteeringMode::Kinematic_Seek);
                    printf("Behavior Of Agent Changed To Kinematic_Seek\n");
                    break;
                case SDLK_2:
                    world_.setAISteering(Body::SteeringMode::Kinematic_Flee);
                    printf("Behavior Of Agent Changed To Kinematic_Flee\n");
                    break;
                case SDLK_3:
                    world_.setAISteering(Body::SteeringMode::Kinematic_Arrive);
                    printf("Behavior Of Agent Changed To Kinematic_Arrive\n");
                    break;
                case SDLK_4:
                    world_.setAISteering(Body::SteeringMode::Kinematic_Wander);
                    printf("Behavior Of Agent Changed To Kinematic_Wander\n");
                    break;
                case SDLK_q:
                    world_.setAISteering(Body::SteeringMode::Seek);
                ...
                case SDLK_w:
                    ...
                    break;
                case SDLK_e:
                    world_.setAISteering(Body::SteeringMode::Arrive);
                    printf("Behavior Of Agent Changed To Arrive\n");
                    break;
                case SDLK_r:
                    world_.setAISteering(Body::SteeringMode::Align);
                    printf("Behavior Of Agent Changed To Align\n");
                    break;
                case SDLK_t:
                    world_.setAISteering(Body::SteeringMode::Velocity_Matching);
                    printf("Behavior Of Agent Changed To Velocity_Matching\n");
                    break;
                case SDLK_a:
                    world_.setAISteering(Body::SteeringMode::Pursue);
                    printf("Behavior Of Agent Changed To Pursue\n");
                    break;
                case SDLK_s:
                    world_.setAISteering(Body::SteeringMode::Face);
                    printf("Behavior Of Agent Changed To Face\n");
                    break;
                case SDLK_d:
                    world_.setAISteering(Body::SteeringMode::LookGoing);
                    printf("Behavior Of Agent Changed To LookGoing\n");
                    break;
                case SDLK_f:
                    world_.setAISteering(Body::SteeringMode::Wander);
